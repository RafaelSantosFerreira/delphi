...
const
	SQL_INSERIR: String =
			'INSERT INTO [dbo].[a043_tes](' + 
				' [a043_AliqIntST], [a043_AliqST], [a043_ajuste_credito], [a043_ajuste_debito], ' + 
				' [a043_aliq_ret], [a043_aliq_ret_sub], [a043_aliquota_frete], [a043_atualiza_est], ' + 
				...
				' [a043_bc_ret_sub], [a043_bc_senar], [a043_cat_pessoa], [a043_cbs], ' + 
				' [a043_cbs_aliquota], [a043_cbs_base_calc], [a043_cod_Enq_ipi], [a043_cod_aj_apuracao_deducao], ' + 
				' [a043_cod_aj_icms_ex_icms], [a043_cod_cidade], [a043_cod_col_mapa], [a043_cod_influencia_recolhimento], ' + 
				' [a043_cod_iva], [a043_cod_obrigacao_a_recolher], [a043_cod_ocorrencia_aj_icms], [a043_cod_origem_tributacao], ' + 
				' [a043_cod_pessoa], [a043_cod_reflexo_apur_icms], [a043_cod_responsabilidade], [a043_cod_sit_trib], ' + 
				' [a043_cod_tes_estorno], [a043_cod_tipo_apuracao], [a043_cod_tipo_credito], [a043_cod_tipo_utilizacao_credito], ' + 
				' [a043_codigo], [a043_codigo_fiscal], [a043_cofins], [a043_cst_cbs], ' + 
				' [a043_cst_ibs], [a043_cst_ipi], [a043_cst_iss], [a043_datetime], ' + 
				...
				' [a043_gera_sped], [a043_ibs], [a043_ibs_aliquota], [a043_ibs_base_calc], ' + 
				' [a043_icm], [a043_ipi], [a043_iss], [a043_iss_aliquota], ' + 
				' [a043_iss_base_calc], [a043_issqn], [a043_margem_subst_tributaria], [a043_mensagem_nf], ' + 
				' [a043_mensagem_nf_01], [a043_mod_base_calculo], [a043_mod_base_calculo_substituicao], [a043_mot_desoneracao], ' + 
				' [a043_mov_cta_capital], [a043_mov_cta_socio], [a043_mov_custo], [a043_mov_desp_secagem], ' + 
				' [a043_obs], [a043_obs_contribuinte], [a043_obs_fiscal], [a043_operacao_tes], ' + 
				' [a043_pBCFCP], [a043_pBCFCPRet], [a043_pBCFCPST], [a043_pCredSN], ' + 
				' [a043_pDif], [a043_pEntMVAST], [a043_pFCP], [a043_pFCPRet], ' + 
				' [a043_pFCPST], [a043_pMVAST], [a043_pST], [a043_p_fcp_st_ret_opc], ' + 
				' [a043_p_fcp_uf_dest_opc], [a043_p_icms_efet_opc], [a043_p_icms_inter], [a043_p_icms_inter_part], ' + 
				' [a043_p_icms_uf_dest], [a043_p_red_bc_efet_opc], [a043_p_senar], [a043_p_st_opc], ' + 
				' [a043_per_cofins_socio], [a043_per_pis_socio], [a043_perc_csll], [a043_perc_inss], ' + 
				' [a043_perc_irrf], [a043_perc_nret_adic], [a043_perc_nret_princ], [a043_perc_red_base_cal_substituicao], ' + 
				' [a043_perc_ret_15], [a043_perc_ret_20], [a043_perc_ret_25], [a043_percentual_residual], ' + 
				' [a043_permite_ibpt], [a043_permite_nf], [a043_pis], [a043_preco_produto], ' + 
				' [a043_red_bc_csll], [a043_red_bc_inss], [a043_red_bc_irrf], [a043_sequencial], ' + 
				' [a043_situacao_tributaria_cofins], [a043_situacao_tributaria_pis], [a043_tab_cofins], [a043_tab_pis], ' + 
				' [a043_tipo_preco], [a043_tipo_tes], [a043_tributacao], [a043_usa_FCP], ' + 
				' [a043_usa_cfop], [a043_usa_funrural], [a043_usa_produtos], [a043_usa_senar], ' + 
				' [a043_usa_trib_pis], [a043_usa_trib_serv], [a043_usuario], [a043_utiliza_preco_pauta], ' + 
				' [a043_v_bc_efet_opc], [a043_v_bc_fcp_st_ret_opc], [a043_v_bc_fcp_uf_dest_opc], [a043_v_bc_st_dest_opc], ' + 
				' [a043_v_bc_st_ret_opc], [a043_v_bc_uf_dest], [a043_v_fcp_st_ret_opc], [a043_v_fcp_uf_dest_opc], ' + 
				' [a043_v_icms_efet_opc], [a043_v_icms_st_dest_opc], [a043_v_icms_st_ret_opc], [a043_v_icms_substituto_opc], ' + 
				' [a043_v_icms_uf_dest], [a043_v_icms_uf_remet], [a043_vinculo_doc_fiscal]  ' + 
				') VALUES( ' + 
				' :a043_AliqIntST, :a043_AliqST, :a043_ajuste_credito, :a043_ajuste_debito, ' + 
				' :a043_aliq_ret, :a043_aliq_ret_sub, :a043_aliquota_frete, :a043_atualiza_est, ' + 
				' :a043_base_calc_icm, :a043_base_calculo_cofins, :a043_base_calculo_frete, :a043_base_calculo_pis, ' + 
